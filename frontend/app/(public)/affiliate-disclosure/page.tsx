      ...
      <section className="py-20 lg:py-28">
        <div className="editorial-container max-w-3xl">
          ...
          <div className="prose-custom space-y-10">
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">What Is an Affiliate Link?</h2>
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">What This Means For You</h2>
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">Our Affiliate Partners</h2>
              <p className="font-body text-navy-800 leading-relaxed mb-4">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">UK CMA Compliance</h2>
              <p className="font-body text-navy-800 leading-relaxed mb-4">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">Editorial Honesty Policy</h2>
              <p className="font-body text-navy-800 leading-relaxed mb-4">

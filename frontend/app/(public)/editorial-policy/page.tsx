    ...
    <>
      ...
      <div className="pt-24 lg:pt-28 bg-background">
        <div className="editorial-container">
          <nav className="flex items-center gap-2 text-sm font-body text-text-muted py-4" aria-label="Breadcrumb">
            ...
            <span className="text-text-secondary">Editorial Policy</span>
          </nav>
        </div>
      </div>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="editorial-container max-w-3xl">
          <ScrollReveal>
            <h2 className="font-display text-3xl font-semibold text-primary mb-8">Our Review Process</h2>
          ...
          <div className="space-y-6">
            {steps.map((step, i) => (
              <ScrollReveal key={step.number} delay={i * 0.08}>
                <div className="flex gap-6 bg-background rounded-xl p-6 border border-border-light">
                  ...
                  <div>
                    ...
                    <p className="font-body text-text-secondary leading-relaxed text-sm">{step.description}</p>
                  </div>
                </div>
              </ScrollReveal>
            ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
            {scoringCriteria.map((criterion, i) => (
              <ScrollReveal key={criterion.title} delay={i * 0.08}>
                <div className="bg-white rounded-2xl p-6 border border-border-light text-center h-full">
                  <span className="text-3xl block mb-3" role="img" aria-hidden="true">{criterion.icon}</span>
                  <h3 className="font-display text-base font-semibold text-primary mb-2">{criterion.title}</h3>
                  <p className="text-xs font-body text-text-secondary leading-relaxed">{criterion.description}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="editorial-container max-w-3xl">
          <ScrollReveal>
            <h2 className="font-display text-3xl font-semibold text-primary mb-6">How We Test</h2>
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="editorial-container max-w-3xl">
          <ScrollReveal>
            <h2 className="font-display text-3xl font-semibold text-primary mb-6">Editorial Independence</h2>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 mb-8">
              <div className="flex items-start gap-3">
                ...
                <p className="font-body text-amber-800 leading-relaxed">
                  <strong>Important:</strong> PetGearHub earns affiliate commissions from purchases made through our links. This is how we fund the site. However, our editorial recommendations are made independently — no commission rate, payment, or brand relationship influences which products we recommend or how we score them.
                </p>
              </div>
            </div>

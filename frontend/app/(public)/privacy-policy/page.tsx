      ...
      <section className="py-20 lg:py-28">
        <div className="editorial-container max-w-3xl">
          <div className="mb-12">
            ...
            <p className="text-sm font-body text-warm-600">Last updated: March 2026</p>
          </div>
          ...
          <div className="space-y-10">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">2. What Personal Data We Collect</h2>
              <p className="font-body text-navy-800 leading-relaxed mb-4">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item.title} className="font-body text-navy-800 leading-relaxed">
                    <strong className="text-navy-900">{item.title}:</strong> {item.desc}
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">3. How We Use Your Data</h2>
              <ul className="space-y-3">
                {[
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">4. Cookies</h2>
              <p className="font-body text-navy-800 leading-relaxed mb-4">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={cookie.title} className="bg-white rounded-lg p-4 border border-warm-200">
                    <p className="font-body font-semibold text-navy-900 text-sm mb-1">{cookie.title}</p>
                    <p className="font-body text-navy-800 text-sm leading-relaxed">{cookie.desc}</p>
                  </div>
                ))}
              </div>
              <p className="font-body text-navy-800 leading-relaxed mt-4">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">5. Third-Party Services</h2>
              <p className="font-body text-navy-800 leading-relaxed mb-4">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">6. Data Retention</h2>
              <ul className="space-y-2 font-body text-navy-800 leading-relaxed">
                <li><strong className="text-navy-900">Newsletter subscribers:</strong> Your email is retained until you unsubscribe. Each newsletter email includes an unsubscribe link.</li>
                <li><strong className="text-navy-900">Contact form submissions:</strong> Retained for up to 12 months, then deleted.</li>
                <li><strong className="text-navy-900">Analytics data:</strong> Aggregated and anonymised; individual data retained for up to 26 months by Google Analytics.</li>
              </ul>
            </div>

            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">7. Your Rights Under UK GDPR</h2>
              <p className="font-body text-navy-800 leading-relaxed mb-4">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">9. Changes to This Policy</h2>
              <p className="font-body text-navy-800 leading-relaxed">

    ...
    <>
      ...
      <section className="py-20 lg:py-28">
        <div className="editorial-container max-w-3xl">
          ...
          <div className="space-y-10 font-body text-navy-800 leading-relaxed">
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">1. Acceptance of Terms</h2>
              <p>
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">2. Use of the Site</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">4. Intellectual Property</h2>
              <p>
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">5. Disclaimer of Warranties</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">6. Limitation of Liability</h2>
              <p>
            ...
            <div>
              <h2 className="font-display text-2xl font-semibold text-navy-900 mb-4">7. Governing Law</h2>
              <p>
